...
describe("settings/agent — chrome des réglages", () => {
  ...
  test("porte AiPage et les trois sections, plus de lien vers /settings/ia", () => {
    ...
    expect(source).toContain("Modèle de l'agent")
    expect(source).toContain("openRouterAgentModel")
    expect(source).toContain("AiModelSelect")
    expect(source).toContain("onSave={(id) => update({ openRouterAgentModel: id })}")
    expect(source).toContain("onSaveModel={(id) => update({ openRouterModel: id })}")
  ...
  test("l'ordre est modèle de l'agent, identité, savoir, applications, modèle IA", () => {
    ...
    const modele = source.indexOf("Modèle de l'agent")
    ...
    expect(modele).toBeGreaterThan(identite)
    expect(fields).toBeGreaterThan(modele)
    expect(savoir).toBeGreaterThan(fields)
