...
// plus bas empêche d'en oublier. Le test "bien formée" ci-dessous garde la
// suite non vide en attendant, pour que ce fichier reste un signal fiable
// en CI (un describe totalement vide masquerait un filtre cassé).
